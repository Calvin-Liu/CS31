           ...
           string result[], int max)
{
    ...
    if(a1[n1-1] >= a2[n2-1] && n1 < n2)
    {
        for(int m = spotInResult; m < n1+n2; m++)
        {
            cout << a1[i] << endl;
            result[m] = a1[i];
            i++;
    ...
    if(a2[n2-1] >= a1[n2-1] && n1 > n2)
    {
        for(int h = spotInResult; h < n2+n1; h++)
        {
            cout << a2[i] << endl;
            result[h] = a2[i];
            i++;
...
//    assert(removeDups(f, 4) == 4);
    
    string x[5] = { "brian", "lois", "lois", "quagmire", "r"};
    string y[5] = { "chris", "lois", "meg", "stewie", "zz"};
    string z[10];
...
//    assert(mingle(e, 5, u, 4, z, 10) == 9 && z[4] == "kid" && z[1] == "chris");
    assert(mingle(y, 4, x, 4, z, 9) == 8 && z[0] == "brian" && z[1] == "chris" && z[2] == "lois" && z[3] == "lois" && z[4] == "lois" && z[5] == "meg" && z[6] == "quagmire" && z[7] == "stewie");
